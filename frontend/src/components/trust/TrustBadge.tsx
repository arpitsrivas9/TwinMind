  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className={`flex items-center gap-2 px-2.5 py-1 rounded-full text-xs font-medium border transition-all duration-200 backdrop-blur-md cursor-pointer ${config.bg}`}
      >
      ...
      {privacyShieldActive && (
        <span
          ...
          className="flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium bg-purple-950/50 border border-purple-800/50 text-purple-300"
        >
