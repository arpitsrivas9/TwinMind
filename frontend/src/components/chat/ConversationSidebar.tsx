...
export function ConversationSidebar({
  ...
  return (
    <aside className="flex h-full w-full flex-col border-r border-border-subtle bg-surface-1/95 overflow-hidden">
        ...
        {deletingId && (
          ...
          >
            <motion.div
              ...
              animate="animate"
              exit="exit"
              className="w-full max-w-sm rounded-xl border border-border-default bg-surface-1 p-5 shadow-xl"
            >
